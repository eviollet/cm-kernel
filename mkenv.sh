export ARCH=arm
export _XXCFLAGS="-march=armv7-a -mfpu=neon -mfloat-abi=softfp -mtune=cortex-a8 -fomit-frame-pointer -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -O2 -Os"
